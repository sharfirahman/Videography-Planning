...
const OUTPUT_FILE     = "src/mdma_greedy/drone_experiments/multi_actor_fpv_figure8.gif\"
const FPS             = 12
...
# Actor 2 (Figure-8, starting far from origin)
const A2_SCALE        = 3.5
const A2_ANG_VEL      = 2π / 20.0
...
actor2_traj = figure_eight_trajectory(
    mesh;
    num_steps        = NUM_STEPS,
    scale            = A2_SCALE,
...
println("  ✓ Actor 2 (figure-8) : $(length(actor2_traj)) steps")
